...
{
    public partial class InitialMigrationWithDataSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "f6d54222-3065-48b8-86e3-8c0c7ad6e7cc", "9371eafb-7787-45de-98b0-e053c6f6dd6f", "Administrator", "ADMINISTRATOR" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Description", "Email", "EmailConfirmed", "IsAdministrator", "IsLocked", "LastLoginDateTime", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RegisterDateTime", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "59d0b519-75a3-40c9-a6a8-2b42ad9e5095", 0, "84c1c222-d549-49d1-ab7c-562dfae6f8e5", null, "admin@email.com", false, true, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, null, "Administrator", "ADMIN@EMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEHA2gOvgy7dBw19s/HzQudtlNHHQPKjLnYWR+N8fb3GjU0hWL21ILDV393eUlPY9WA==", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "e4f0be57-78e8-43ad-9cdb-973d181ba733", false, "admin" });
